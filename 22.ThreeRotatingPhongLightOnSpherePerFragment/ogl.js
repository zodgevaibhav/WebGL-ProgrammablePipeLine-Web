...
var light_position_green=[100.0,100.0,100.0,1.0];
...
var laUniform, ldUniform_red,ldUniform_blue,ldUniform_blue, lsUniform, lightPositionUniform_red, lightPositionUniform_green, lightPositionUniform_blue;
...
function draw()
{
    ...
    if(lButtonPressed==true)
    {
        gl.uniform1i(LKeyPressedUniform, 1);
			 ...
			 light_position_red[0] = Math.cos(angleRotateRed)*100.0;
			 light_position_red[1]=0.0;
			 light_position_red[2]=Math.sin(angleRotateRed)*100.0;
			 light_position_red[3]=100.0;

			 light_position_green[0] = 0.0;
			 light_position_green[1]=Math.cos(angleRotateGreen)*100.0;
			 light_position_green[2]=Math.sin(angleRotateGreen)*100.0;
			 light_position_green[3]=100.0 ;

			 light_position_blue[0] = -Math.cos(angleRotateBlue)*100.0;
			 light_position_blue[1]=0.0;
			 light_position_blue[2]=Math.sin(angleRotateBlue)*100.0;
			 light_position_blue[3]=100.0;
        ...
        gl.uniform3fv(ldUniform_red, light_diffuse_red); // diffuse intensity of light
		gl.uniform3fv(ldUniform_green, light_diffuse_green); // diffuse intensity of light
		gl.uniform3fv(ldUniform_blue, light_diffuse_blue); // diffuse intensity of light
        
		gl.uniform4fv(lightPositionUniform_red, light_position_red); // light position
		gl.uniform4fv(lightPositionUniform_green, light_position_green); // light position
		gl.uniform4fv(lightPositionUniform_blue, light_position_blue); // light position
